 ...
 *
 * controllerDp_emxutil.h
 *
 * Code generation for function 'controllerDp_emxutil'
 *
 */

#ifndef __CONTROLLERDP_EMXUTIL_H__
#define __CONTROLLERDP_EMXUTIL_H__
...
/* End of code generation (controllerDp_emxutil.h) */

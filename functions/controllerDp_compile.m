% CONTROLLERDP_COMPILE_NEW   Generate MEX-function controllerDp_mex from
%  controllerDp.
% 
% Script generated from project 'controllerDp.prj' on 21-Aug-2016.
% 
...
ARGS{1}{1}.opt.statesTotal = coder.typeof(0);
...
ARGS{1}{4}.cfg.opt.statesTotal = coder.typeof(0);

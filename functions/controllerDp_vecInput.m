function [bestDischargeStep, bestCTG] = controllerDp_vecInput(cfg,...
    demForecast, pvForecast, battery, hourNow)

% controllerDp_vecInput: version of controllerDp with fixed parameters
                       % hard-coded and all input as a single vector.

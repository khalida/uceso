function [ forecastEts ] = getEtsForecastR( ...
    historicData, trainControl )

% getEtsForecastR: Produce point forecast using R forecasting pkg
...
mkdir(tmpName);
[locationOfRfile, ~, ~] = fileparts(which('getEtsForecastR.m'));
